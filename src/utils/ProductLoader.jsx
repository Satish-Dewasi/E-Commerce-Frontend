...
function ProductLoader() {
  return (
    <div className=" w-full h-[90vh] flex flex-wrap items-center justify-between b-red-300">
      {Array.from({ length: 6 }).map((_, i) => (
        <div key={i}>
          <div className="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-80 sm:w-96 animate-pulse">
