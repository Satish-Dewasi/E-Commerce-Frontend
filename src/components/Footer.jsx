...
function Footer() {
  return (
    <>
      <div className=" footer-grid mt-[8rem] sm:mt-0   h-auto px-[2rem] sm:px-[4rem]   ">
        <div className="  footer-grid-item  bg--200 mt-5 sm:mt-0   gap-[2rem]   ">
          ...
          <input
            ...
            type="email"
          />
          <button className=" bg-[#0075be] text-[1.6rem] uppercase tracking-wider font-[600] text-white px-10 py-4 ">
            Subscribe
          </button>
        </div>

        <div className="  px-[2rem] flex items-start justify-between     ">
          <div className=" w-1/2  bg--400 ">
            <h1 className=" text-[2.5rem] tracking-wide font-semibold ">
              For Men
            </h1>
        ...
        <div className=" h-[12vh] lg:items-start footer-grid-item mt-[4rem] md:mt-0  roboto-regular text-black  ">
      ...
      <div className=" w-full h-[2vh] bg-black "> </div>
    </>
  );
}
